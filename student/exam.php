...
if (!$exam_session) {
    ...
    // Use objective_duration for objective questions section
    $objective_duration = $exam['objective_duration'] ?: $exam['duration_minutes'];
    $end_time = date('Y-m-d H:i:s', strtotime("+{$objective_duration} minutes"));
...
$time_remaining = max(0, $end_timestamp - $current_time);
?>
<!DOCTYPE html>
<html lang="en">
...
.timer-container {
    ...
    border-radius: 8px;
    text-align: center;
    min-width: 130px; /* Slightly smaller */
}
...
<body>
    <div class="fixed-header">
        <div class="exam-info">
            ...
            <p><strong>Section:</strong> Objective Questions</p>
        </div>
                            ...
                            <div class="question-page" id="questionPage<?php echo $index + 1; ?>" style="<?php echo $index === 0 ? '' : 'display: none;'; ?>">
                                <div class="question">
                                    ...
                                    <div class="question-text">
                                        <?php
                                        // Render question text with MathJax support
                                        $question_text = htmlspecialchars($question['question_text']);
                                        // Convert LaTeX delimiters if needed
                                    ...
                                    <div class="options">
                                        ...
                                        <?php foreach ($shuffled_keys as $key_index => $key): ?>
                                            <label class="option" for="option_<?php echo $question['id']; ?>_<?php echo $key; ?>">
                                                ...
                                                <span>
                                                    <?php
                                                    $option_text = htmlspecialchars($shuffled_options[$key]);
    ...
    <script>
        ...
        const examDuration = <?php echo $time_remaining; ?>; // Use calculated remaining time
